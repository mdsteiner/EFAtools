...
be checked against the program it emulates. `?efa_fit` lists the exact settings each preset
selects, along with the one place a preset alone is not enough: `"psych"` also needs
`normalize = FALSE` to match `psych::fa()`'s promax, because every preset keeps EFAtools'
