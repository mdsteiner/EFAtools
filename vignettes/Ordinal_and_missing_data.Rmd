...
We draw 400 responses on a four-category scale. `match = "polychoric"` sets the category
thresholds so that the population *polychoric* correlation of the discretised data equals
...
item's missingness depends on another item's value.
