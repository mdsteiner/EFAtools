...
factorable. The determinant looks small, but it is a product of 30 eigenvalues and falls as
variables are added; the condition index (6.8) is the measure that does not move with the
number of variables, and it shows no multicollinearity. More interesting are the last few
