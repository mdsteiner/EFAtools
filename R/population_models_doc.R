...
#' Grieder and Steiner (2019). All combinations of the loadings, factor
#' intercorrelations, and sample sizes (180 vs. 450) were used in the simulations. Many models are based on cases
...
#'   \item{case_9b}{(matrix) - Small number of indicators per factor, in this case 3, with different loadings within all factors.}
