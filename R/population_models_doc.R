...
#'   \item{case_1a}{(matrix) - Small number of subtests per factor, in this case 2.}
#'   \item{case_1b}{(matrix) - Small number of subtests per factor, in this case 3. Case 5 in de Winter and Dodou (2012).}
