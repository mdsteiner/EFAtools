#' Print VARIMAX object
#'
#' Print method showing a summarized output of the VARIMAX procedure.
#'
#' @param x list. An object of class VARIMAX to be printed
