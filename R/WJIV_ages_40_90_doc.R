...
#'
#' A list containing the bivariate correlations (N = 1146) of the 47
#' intelligence subtests from the WJ-IV for 40 to 90+ years olds obtained from
...
#'
#'
#' @format A list of 2 with elements "n" (scalar) and "cormat" (47 x 47 matrix of bivariate correlations)
#' \describe{
