...
paf_mac <- .PAF(test_models$baseline$cormat, n_factors = 3, N = 500,
...
test_that("output class and dimensions are correct", {
  ...
  expect_is(paf_mac$unrot_loadings, "LOADINGS")
  ...
  expect_output(str(paf_mac), "List of 11")
})
...
test_that("original correlation matrix and eigenvalues are correct", {
  ...
  expect_equal(paf_mac$orig_R, test_models$baseline$cormat)
  ...
  expect_equal(sum(paf_mac$orig_eigen), ncol(test_models$baseline$cormat))
  ...
  expect_lt(sum(paf_mac$final_eigen), ncol(test_models$baseline$cormat))
})
...
test_that("fit indices are returned correctly", {
  ...
  expect_output(str(paf_mac$fit_indices), "List of 12")
  ...
  expect_equal(paf_none$fit_indices[c("chi", "CFI", "RMSEA", "RMSEA_LB",
               ...
               list(chi = NA, CFI = NA, RMSEA = NA, RMSEA_LB = NA, RMSEA_UB = NA,
                    AIC = NA, BIC = NA, Fm = NA, chi_null = NA, df_null = NA))
  expect_equal(paf_mac$fit_indices[c("chi", "CFI", "RMSEA", "RMSEA_LB",
                                      "RMSEA_UB", "AIC", "BIC", "Fm",
                                      "chi_null", "df_null")],
               list(chi = NA, CFI = NA, RMSEA = NA, RMSEA_LB = NA, RMSEA_UB = NA,
                    AIC = NA, BIC = NA, Fm = NA, chi_null = NA, df_null = NA))
  ...
  expect_is(paf_mac$fit_indices$df, "numeric")
  ...
  expect_is(paf_mac$fit_indices$CAF, "numeric")
...
test_that("settings are returned correctly", {
  ...
  expect_named(paf_none$settings, c("max_iter", "init_comm", "criterion",
                                    "criterion_type", "abs_eigen"))
  expect_named(paf_mac$settings, c("max_iter", "init_comm", "criterion",
                                    "criterion_type", "abs_eigen"))
  ...
  expect_equal(paf_mac$settings$max_iter, 500)
  ...
  expect_equal(paf_mac$settings$init_comm, "mac")
  ...
  expect_equal(paf_mac$settings$criterion, 1e-4)
  ...
  expect_equal(paf_mac$settings$criterion_type, "sums")
  ...
  expect_equal(paf_mac$settings$abs_eigen, TRUE)
})
...
rm(paf_efatools, paf_psych, paf_spss, paf_none, paf_mac)
